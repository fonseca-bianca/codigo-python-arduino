Esse é um exemplo didático de uso de linguagem Python para configuração de software da plataforma Arduino para um sistema de irrigação automática a ser implementado em uma floricultura.
